'use strict';function p(b){this.position=b}const r=function(){var b={};Array.from('"\\/bfnrtu').forEach(d=>b[d]=!0);return b}(),t=/[0-9a-fA-F]/;
function u(b,d){function e(a){return b.substring(g,g+a.length)===a}function c(a){if(!e(a))throw new p(g);g+=a.length}function f(){var a=/[^\s]/g;a.lastIndex=g;g=(a=a.exec(b))?a.index:b.length}function k(){return b.charAt(g)}function h(){++g;return k()}var g=d||0;"number"!==typeof g&&(g=0);const m={s:function(){c('"');for(var a=!1;'"'!==b.charAt(g)||a;)if(a){if("u"===k())for(++g,a=0;4>a;++a){if(!t.test(k()))throw new p(g);++g}else if(r[k()])++g;else throw new p(g);a=!1}else a="\\"===k()?!0:!1,++g;
c('"')},n:function(){var a=k();for("-"===a&&(a=h());"0"<=a&&"9">=a;)a=h();if("."===a)for(a=h();"0"<=a&&"9">=a;)a=h();if("e"===a||"E"===a){a=h();if("+"===a||"-"===a)a=h();for(;"0"<=a&&"9">=a;)a=h()}},k:function(){[!0,!1,null].map(String).find(function(a){return e(a)?(c(a),!0):!1})},o:function(){c("{");for(f();!e("}");){m.s();f();c(":");m._();f();if(e("}"))break;c(",");f()}++g},a:function(){c("[");for(f();!e("]");){m._();f();if(e("]"))break;c(",");f()}++g},_:function(){f();var a=k(),l={tfn:"k","{":"o",
"[":"a","-0123456789":"n",'"':"s"},n;for(n in l)if(1<n.length)for(var q of n)l[q]=l[n];if((a=l[a])&&m[a])m[a].call(m);else throw new p(g);}};m._();return g}function v(b){return new Promise((d,e)=>{var c=new FileReader;c.onload=function(){d(c.result)};c.onerror=function(){e("error loading file")};c.readAsText(b,"UTF-8")})}function w(b,d){d=d||0;for(var e=[],c=0;c<b.length;){var f=40-d;d=0;e.push(b.substring(c,c+f));c+=f}return e}
...
((b,d)=>{function e(a,l){var n=!1;Array.prototype.slice.call(a.files).forEach(function(q){n=!0;d(q,l)});return n}function c(a){a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="copy";a.currentTarget.classList.add("dragOver")}function f(a){a.stopPropagation();a.preventDefault();e(a.dataTransfer,a);a.currentTarget.classList.remove("dragOver")}function k(a){a.currentTarget.classList.add("dragOver")}function h(a){a.currentTarget.classList.remove("dragOver")}const g={};var m=!1;g.bind=
()=>{m=!0;b.addEventListener("dragover",c,!1);b.addEventListener("drop",f,!1);b.addEventListener("dragenter",k,!1);b.addEventListener("dragleave",h,!1)};g.b=()=>{m&&(b.removeEventListener("dragover",c,!1),b.removeEventListener("drop",f,!1),b.removeEventListener("dragenter",k,!1),b.removeEventListener("dragleave",h,!1),m=!1)};g.bind();return g})(document.body,B);
